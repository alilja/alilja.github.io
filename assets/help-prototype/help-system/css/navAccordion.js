/* Nav Accordion Plugin v1.1.2
   - Modified to disable accordion reset on window resize.
   - Modified to disable margin setting based on button width. This will be controlled by CSS instead.
   - Modified to disable auto button line height based on innerHeight of LI element
************************************/
(function($){
...
*/  // Modified to prevent setting margin based on button width
			...
			//REMOVED. iOS devices interpreted accordion expansion as a resize event, which 
			//immediately triggered the buttonheightResize function, which closed the 
			//just-opened section.
...
// Removed code that sets line-height to same as button height (resulted in vertical centering)
							.css({'height': 'calc(-0.5rem + ' + lineheight + 'px)'});
// Added code to calculate button height based on 0.5rem of top padding from AppHelp.css,
// which is needed to align the button with the first line of an entry.
